...
import static creditCardValidation.CardType.*;
...
//      assertEquals(myCard.getNumberArray(number));
 // }
    ...
    @Test
    void creditCardHasType(){
        int[] number = {4,3,8,8,5,7,6,0,1,8,4,0,2,6,2,6};
        int d = 4;
        assertEquals(VISA,myCard.getCardType(number,d));

    }
    @Test
    void creditCardHasAmericaCardType(){
        int[] number = {3, 7, 8, 8, 5, 7, 6, 0, 1, 8, 4, 0, 2, 6,2};
        int d = 37;
        assertEquals(AMERICA, myCard.getCardType(number,d));
        number = new int[]{6, 4, 8, 8, 5, 7, 6, 0, 1, 8, 4, 0, 2, 6, 6, 2};
        d = 6;
        assertEquals(VERVE,myCard.getCardType(number,d));
        number = new int[]{5, 4, 8, 8, 5, 7, 6, 0, 1, 8, 4, 0, 2, 6, 6,2};
        d = 5;
        assertEquals(MASTER,myCard.getCardType(number,d));
        number = new int[]{8, 4, 8, 8, 5, 7, 6, 0, 1, 8, 4, 0, 2, 6, 6,2};
        d = 8;
        assertEquals(null,myCard.getCardType(number,d));
    }
}